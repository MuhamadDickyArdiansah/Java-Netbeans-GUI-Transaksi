...
public class jersey extends javax.swing.JFrame {
    ...
    public jersey(String username, double saldo) {
        initComponents();
        ...
        JButton[] btns = {jButton1, jButton3, jButton4, jButton5, jButton5, jButton6};
    ...
    private void loadTable() {
        ...
        lsJersey = cmdJersey.getAllJersey();

        String[][] dtJersey = new String[lsJersey.size()][4];
        int i = 0;
        for (Jersey jersey : lsJersey) {
            dtJersey[i][0] = String.valueOf(i + 1);
            dtJersey[i][1] = jersey.getKode_barang();
            dtJersey[i][2] = jersey.getNama_barang();
            dtJersey[i][3] = "" + jersey.getHarga();
    ...
    private void btncektotalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncektotalActionPerformed
        ...
        if (banyak > 0){
            ...
            jersey.setKode_barang(txtkodebarang.getText());
            jersey.setHarga(jumlah);
            double diskon = jersey.hitungHargaFinal();
